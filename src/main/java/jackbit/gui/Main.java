...
public class Main extends Application {
    ...
    public void start(Stage stage) {
        ...
        //First Jackbit message
        ui = new Ui();
        dialogContainer.getChildren().addAll(DialogBox.getJackDialog(ui.welcome(), jackImage));
    ...
    private void handleUserInput(Stage stage) {
        ...
        String jackBitText = jackbit.run(userText);
        dialogContainer.getChildren().addAll(
                DialogBox.getUserDialog(userText, userImage),
                DialogBox.getJackDialog(jackBitText, jackImage)
        );
        userInput.clear();

        // Close the window if the user says "bye"
